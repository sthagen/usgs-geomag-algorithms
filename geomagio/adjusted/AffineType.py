...
class AffineType(str, enum.Enum):
    ...
    def calculate_matrix(self, ord_hez, abs_xyz, weights=1):
        ...
        if self in [
            AffineType.NO_CONSTRAINTS,
            AffineType.Z_ROTATION,
            AffineType.Z_ROTATION_HSCALE,
            AffineType.Z_ROTATION_HSCALE_ZBASELINE,
            AffineType.RESCALE_3D,
            AffineType.TRANSLATE_ORIGINS,
            AffineType.SHEAR_YZ,
        ]:
            if weights != 1:
            ...
            ord_st_r = ord_st.T.ravel() * weights

        if self in [
            AffineType.QR_FACTORIZATION,
            AffineType.ROTATION_TRANSLATION_3D,
            AffineType.ROTATION_TRANSLATION_XY,
        ]:
            if weights == 1:
                # equal weighting
        ...
        if self == AffineType.NO_CONSTRAINTS:
        ...
        if self == AffineType.Z_ROTATION_HSCALE:
        ...
        if self == AffineType.Z_ROTATION_HSCALE_ZBASELINE:
        ...
        if self == AffineType.ROTATION_TRANSLATION_3D:
        ...
        if self == AffineType.TRANSLATE_ORIGINS:
        ...
        if self == AffineType.ROTATION_TRANSLATION_XY:
        ...
        if self == AffineType.QR_FACTORIZATION:
